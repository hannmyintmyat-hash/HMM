...
You can also use RPC to communicate between Workers and [Durable Objects](/durable-objects/features/create-durable-object-stubs-and-send-requests/#invoke-rpc-methods).
:::
