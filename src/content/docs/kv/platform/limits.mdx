...
Workers KV is available to both the Free and Paid Workers plans. See [pricing](/kv/platform/pricing/) for more details. These are the limits that apply to a Cloudflare account:
