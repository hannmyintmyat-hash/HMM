...
For all messages, basic metadata is retained. Basic metadata includes sender, recipient, subject, message_id, and delivery logs.

For detections, full messages are retained.

Data retention periods are defined by service level purchased by the customer. Advantage customers receive 90 days, while Enterprise customers receive 1 year.